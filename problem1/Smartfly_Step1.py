...
# 16. Distance travelled (miles)        # Irrelevant
...
import os
sys.path.append('.')
# use some local dictionaries we created earlier
...
for data in sys.stdin:
	...
	if origin == airport:
		if  dep_delay.isdigit() and dep_delay > '0' and (cancelled == '0' or cancelled == 'NA'): 
       	        	print '1 1:%f 2:%f 3:%f 4:%f 5:%f 6:%f 7:%f 8:%f 9:%f' %  \
                        (dep_hour \
                        ,int(month) \
                        ,int(dom) \
                        ,int(dow) \
			...
			,float(distance)
       	        	...
       	        	print '0 1:%f 2:%f 3:%f 4:%f 5:%f 6:%f 7:%f 8:%f 9:%f' %  \
                        (dep_hour \
                        ,int(month) \
                        ,int(dom) \
                        ,int(dow) \
